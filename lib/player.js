...
shaka.Player = class extends shaka.util.FakeEventTarget {
  ...
  constructor(mediaElement, videoContainer = null, dependencyInjector) {
    ...
    /** @private {?boolean} */
    this.filterVariantTracksByActiveVariant = false;
  ...
  applyConfig_() {
    ...
    if (this.config_.enableFilterVariantTracks) {
      this.filterVariantTracksByActiveVariant = true;
    } else {
      this.filterVariantTracksByActiveVariant = false;
    }
  }
  ...
  getVariantTracks() {
    if (this.manifest_ && !this.isRemotePlayback()) {
      ...
      for (const variant of this.manifest_.variants) {
        ...
        if (track.active) {
          activeTracks++;
          if (this.filterVariantTracksByActiveVariant === true) {
      ...
      // with the videoIdFilter track when casting. Refer to issue #8588
      if (!filterVideoId) {
        return tracks;
      } else {
  ...
  defaultConfig_() {
    ...
    shaka.log.debug('enableFilterVariantTracks',config.enableFilterVariantTracks);
    return config;
  }
